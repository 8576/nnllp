...
class Config(object):
    ...
    """配置参数"""
    def __init__(self, datafile, embedding):
        self.model_name = 'FastText'
        # self.data_file = os.path.join("THUCNews\data", datafile)                       # 数据集
        # self.dev_path = dataset + '/data/dev.txt'                                    # 验证集
        # self.test_path = dataset + '/data/test.txt'                                  # 测试集
        # self.class_list = [x.strip() for x in open(
        #     dataset + '/data/class.txt', encoding='utf-8').readlines()]              # 类别名单
        dataset = "THUCNews"
        self.class_list = list(range(14))
        ...
        self.batch_size = 168                                           # mini-batch大小
        self.pad_size = 3800                                            # 每句话处理成的长度(短填长切)
        self.learning_rate = 1.5e-3                                       # 学习率
